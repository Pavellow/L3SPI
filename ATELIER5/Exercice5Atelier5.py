...
TAILLE_LISTE = [10,500,5000,50000]
NBR_EXECUTION = 5
NBR_SAMPLE = 20
...
# #correspond auxééééé point d'abscisse le
...
print(perf_sample(extract_elements_list, random.sample, TAILLE_LISTE[2], NBR_EXECUTION, NBR_SAMPLE))